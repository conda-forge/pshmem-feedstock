...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pshmem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11815&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pshmem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pshmem` can be installed with:

```
conda install pshmem
```

It is possible to list all of the versions of `pshmem` available on your platform with:
